            ...
            <AnimatedSection className="container pt-16">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold tracking-tight mb-4">
                        Dịch vụ AI tự động hàng đầu
                    </h2>
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        Chúng tôi cung cấp các dịch vụ AI tự động giúp doanh nghiệp của bạn tối ưu
                        hóa quy trình, tiết kiệm thời gian và tăng hiệu quả kinh doanh.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center text-center p-6 border rounded-lg shadow-sm">
                        ...
                        <h3 className="text-xl font-semibold mb-2">
                            Đăng bài viết tự động bằng AI
                        </h3>
                        <p className="text-muted-foreground mb-4">
                            Tự động tạo và đăng bài viết chất lượng cao lên Facebook Page hoặc
                            Website của bạn với sự hỗ trợ của AI.
                        </p>
                    ...
                    <div className="flex flex-col items-center text-center p-6 border rounded-lg shadow-sm">
                        ...
                        <p className="text-muted-foreground mb-4">
                            Huấn luyện chatbot AI để chăm sóc khách hàng trên Zalo, Telegram,
                            Facebook, Shopee và các nền tảng khác.
                        </p>
                        <Button asChild className="mt-auto">
                    ...
                    <div className="flex flex-col items-center text-center p-6 border rounded-lg shadow-sm">
                        ...
                        <p className="text-muted-foreground mb-4">
                            Tự động gửi tin nhắn đến khách hàng tiềm năng hoặc khách hàng hiện tại
            ...
            <AnimatedSection className="bg-slate-50 py-16">
                <div className="container">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Chúng tôi cung cấp nhiều gói dịch vụ khác nhau để phù hợp với nhu cầu và
                            ngân sách của bạn.
                        </p>
                    </div>
